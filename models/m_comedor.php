<?php
    ...
    class m_comedor extends m_db{
        private $id_comedor, $nom_comedor, $encargado_comedor, $direccion_comedor, $status_comedor;

        public function __construct(){
            parent::__construct();
            $this->id_comedor = $this->nom_comedor = $this->status_comedor = $this->encargado_comedor = $this->direccion_comedor = "";
        }
        ...
        public function Create(){
            ...
            $sql = "INSERT INTO comedor(id_comedor, nom_comedor, encargado_comedor, direccion_comedor, status_comedor, created_comedor) VALUES(null,'$this->nom_comedor',$this->encargado_comedor,'$this->direccion_comedor', $this->status_comedor, NOW());";
            $this->Query($sql);
        ...
        public function Update(){
            ...
            $sql = "UPDATE comedor SET nom_comedor = '$this->nom_comedor', encargado_comedor = $this->encargado_comedor, direccion_comedor = '$this->direccion_comedor'
