          ...
          <!-- <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Reportes de entradas</h3>
                </div>
                      ...
                      <div class="col-3">
                        ...
                        <div class="row">
                          <div class="form-check mx-3">
                            <input type="radio" name="tipo_reporte" id="tipo_reporte" value="E" class="form-check-input" readonly checked>
                            <label for="tipo_reporte" class="form-check-label">Entrada</label>
                          </div>
                          <div class="form-check">
                            <input type="radio" name="tipo_reporte" id="tipo_reporte" value="S" class="form-check-input" disabled>
